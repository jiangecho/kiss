...
//                try {
//                    showAd = data.getString("showAd");
//                    showBannerAd = data.getString("showBannerAd");
//                    String tmpAdTag = data.getString("adTag");
//                    String tmpBannerAdTag = data.getString("bannerAdTag");
//
//                    if (tmpAdTag != null) {
//
//                    }
//                    Log.e("jyj", showAd + " " + showBannerAd);
